...
-- Quit
vim.api.nvim_set_keymap('i', '<F8>', '<cmd>q<CR>', { noremap = false, silent = true })
vim.api.nvim_set_keymap('v', '<F8>', '<cmd>q<CR>', { noremap = false, silent = true })
vim.api.nvim_set_keymap('n', '<F8>', '<cmd>q<CR>', { noremap = false, silent = true })
